...
export const ScriptSections = ({ darkMode, userViewMode = false }: ScriptSectionsProps) => {
  ...
  return (
    <>
      ...
      <div className="mb-6 rounded-xl border-2 border-red-300 dark:border-red-800/70 bg-red-100/80 dark:bg-red-950/40 shadow-sm p-4">
        <div className="flex items-center justify-center gap-2.5">
          <AlertTriangle className="w-5 h-5 text-red-600 dark:text-red-400 flex-shrink-0" />
          <p className="text-sm sm:text-base font-extrabold text-red-800 dark:text-red-200 text-center uppercase tracking-wide">
