...
const Index = () => {
  ...
  const TAB_DEFS: Array<{
    ...
    { key: 'tab_dashboard', type: 'tab', value: 'dashboard', defaultTitle: 'Central de Desenvolvimento Pride', defaultShortTitle: 'Central de Desenvolvimento Pride', icon: <img src={logoPrideCircle} alt="Pride" className="w-6 h-6 sm:w-7 sm:h-7 object-contain flex-shrink-0" /> },
          ...
          <Tabs value={activeTab} onValueChange={(v) => {
            ...
            <TabsContent value="avaliacoes" forceMount className="mt-0 data-[state=inactive]:hidden">
              ...
              {(() => {
                ...
                return (
                  <iframe
                    key={`avaliacoes-${isAdmin ? 'adm' : 'user'}-${user?.id ?? 'anon'}`}
