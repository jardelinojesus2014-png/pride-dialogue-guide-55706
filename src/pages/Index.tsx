            ...
            <TabsContent value="prospeccao" className="mt-0">
              ...
              <div className="mb-6 flex justify-center">
                <button
                  ...
                  className="bg-gradient-to-r from-orange-500 via-red-600 to-purple-700 hover:from-orange-600 hover:via-red-700 hover:to-purple-800 text-white font-black px-8 py-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-105 text-sm sm:text-base animate-[pulse_8s_ease-in-out_infinite]"
